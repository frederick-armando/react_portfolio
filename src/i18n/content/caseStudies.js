  ...
  fr: {
    ...
    'tire-assistant': {
      ...
      sections: {
        ...
        tradeoffs: {
          title: "Arbitrages",
          paragraphs: [
            "Le principal arbitrage était d’augmenter la proactivité sans transformer l’assistant en interruption. Les notifications devaient rester contextuelles, lisibles et limitées aux moments où elles pouvaient réellement aider la décision.",
            "J’ai aussi veillé à préserver l’expérience existante et le référencement organique : la couche proactive devait enrichir le parcours sans remplacer les contenus déjà utiles ni détourner l’utilisateur de son objectif."
          ]
        },
        solution: {
          title: "Solution",
    ...
    masteos: {
      ...
      sections: {
        ...
        obstacles: {
          title: "Arbitrage : simplifier sans appauvrir",
          paragraphs: [
        ...
        launch: {
          title: "Livraison et lancement",
          paragraphs: [
            "Après plusieurs mois d’itérations, de tests et d’alignement avec les équipes produit et engineering, nous avions une expérience suffisamment claire pour être lancée. Le lancement devait valider une hypothèse simple : rendre l’investissement immobilier plus lisible sans masquer sa complexité réelle."
          ]
        },
        results: {
          title: "Impact",
          paragraphs: [
            "Les premiers retours ont confirmé la valeur de la refonte. En seulement trois mois, nous avons vu les inscriptions augmenter de 200 %. Les utilisateurs passaient en moyenne 15 minutes par session sur l'application, avec une compréhension plus claire de leurs options d'investissement."
          ]
        },
        validation: {
    ...
    helios: {
      ...
      sections: {
        intro: { title: "Contexte interne", paragraphs: ["Alors que l'application Masteos prenait son envol, une nouvelle aventure se profilait à l'horizon. Notre équipe, encore euphorique du succès de Masteos, faisait face à un nouveau défi : créer le back-office qui allait propulser Masteos vers de nouveaux sommets."] },
        users: { title: "Utilisateurs et besoins", paragraphs: ["J'étais de nouveau aux commandes en tant que Product Designer UX/UI, mais cette fois-ci, le défi était différent. Nous ne parlions plus aux investisseurs, mais aux héros méconnus de Masteos : nos collaborateurs internes. Sales, chasseurs immobiliers, gestionnaires... Chacun avait des besoins spécifiques, et c'était à nous de les satisfaire tous."] },
        challenge: { title: "Contraintes de delivery", paragraphs: ["Le plus grand défi était de mener deux produits majeurs en parallèle. Notre équipe, composée d'un PM, quatre développeurs et moi-même, devait maintenir l'élan de Masteos tout en construisant Helios de A à Z, avec des décisions rapides et un niveau de documentation suffisant pour sécuriser la livraison."] },
        daily: { title: "Arbitrage entre deux produits", paragraphs: ["Nos journées alternaient entre l’amélioration de l’expérience investisseur et la conception du back-office interne. Cette dualité demandait de prioriser les irritants les plus structurants et de garder une cohérence produit entre ce que voyaient les clients et ce que manipulaient les équipes."] },
        questions: { title: "Recherche interne", paragraphs: ["Pour comprendre les besoins d'Helios, nous avons mené plus de 15 interviews avec nos collègues. Chaque conversation révélait de nouvelles complexités. Comment simplifier l'ajout de biens immobiliers ? Comment optimiser le positionnement des clients ? Ces questions s'ajoutaient à la pile déjà conséquente de défis que nous relevions quotidiennement avec Masteos."] },
        workshop: { title: "Décisions de co-conception", paragraphs: ["L'un des moments les plus marquants fut lorsque nous avons organisé un atelier de co-création. Voir nos collègues des ventes, de l'immobilier et de la gestion réunis dans une même pièce, partageant leurs frustrations et leurs rêves pour Helios, fut une révélation. C'est là que j'ai vraiment compris l'ampleur de notre tâche : nous ne construisions pas simplement un outil, nous redéfinissions la façon dont Masteos opérait en coulisses."] },
        battleground: { title: "Du besoin au prototype", paragraphs: ["Entre les wireframes pour de nouvelles fonctionnalités de Masteos et les prototypes haute-fidélité pour Helios, l’enjeu était de transformer des besoins opérationnels parfois contradictoires en parcours testables. Chaque itération nous rapprochait d’un outil plus clair pour les équipes internes."] },
        launch: { title: "Mise en production", paragraphs: ["Le lancement d’Helios devait prouver que le back-office pouvait simplifier des processus complexes sans déplacer la complexité vers les équipes. Le déploiement a donc été pensé comme une étape de validation produit autant que comme une livraison technique."] },
        success: { title: "Impact", paragraphs: ["La réponse ne tarda pas à venir. En l'espace de six mois, notre NPS interne passa de 6,5 à 8,7. Le temps de traitement d'un dossier d'investissement fut réduit de 40%. Mais le commentaire qui me toucha le plus fut celui de Laura, de l'équipe Sales : \"C'est comme si nous étions passés de la conduite d'une voiture manuelle à une voiture automatique de luxe.\""] },
        evolution: { title: "Écosystème produit", paragraphs: ["Ce succès ne marquait pas la fin, mais plutôt un nouveau début. Avec Helios et Masteos fonctionnant en tandem, nous avions créé un écosystème complet. L'un ne pouvait exister sans l'autre, et ensemble, ils transformaient l'industrie de l'investissement immobilier."] },
        innovation: { title: "Évolutions possibles", paragraphs: ["Aujourd'hui, alors que nous envisageons l'intégration de l'IA et le développement d'une application mobile pour Helios, je ne peux m'empêcher de sourire. Ce voyage m'a appris que la véritable innovation ne se limite pas à ce que les clients voient. Elle réside aussi dans les systèmes qui alimentent ces expériences en coulisses."] },
        design: { 
          title: "Enseignements", 
          paragraphs: [
    ...
    myxpert: {
      ...
      sections: {
        ...
        legacy: {
          title: "Problème : fragmentation des outils",
          paragraphs: [
        ...
        pivot: {
          title: "Décision clé : passer au natif",
          paragraphs: [
        ...
        agile: {
          title: "Alignement produit / tech / métier",
          paragraphs: [
        ...
        jargon: {
          title: "Décision UX : réduire le jargon",
          paragraphs: [
        ...
        launch: {
          title: "Impact produit et legacy",
          paragraphs: [
        ...
        learnings: {
          title: "Enseignements de leadership",
          paragraphs: [
    ...
    kirrk: {
      ...
      sections: {
        intro: { title: "Contexte", paragraphs: ["Avril 2019. Le printemps parisien battait son plein lorsque je rejoignis l'équipe de Kirrk, une start-up ambitieuse dans le domaine de l'autopartage. Mon rôle ? UX/UI Designer, avec la mission de transformer leur vision audacieuse en une réalité digitale palpable."] },
        ambition: { title: "Problème produit", paragraphs: ["Kirrk était mon projet principal, le cœur de mon activité professionnelle pour les deux années et demie à venir. Notre objectif était clair mais ambitieux : simplifier l'utilisation des flottes de véhicules en entreprise. Notre équipe, composée d'une vingtaine de développeurs, d'un ou deux designers selon les phases et d'un chef de produit, devait créer une plateforme d'autopartage fluide pour les utilisateurs comme pour les gestionnaires."] },
        challenges: { title: "Contraintes et enjeux", paragraphs: ["Les défis étaient titanesques. Comment optimiser l'utilisation des flottes ? Comment réduire les coûts opérationnels tout en offrant une expérience utilisateur fluide ? Et surtout, comment promouvoir une mobilité durable dans un monde encore trop dépendant des énergies fossiles ?"] },
        daily: { title: "Décisions de conception", paragraphs: ["Le quotidien alternait entre cadrage fonctionnel, conception des parcours, tests utilisateurs terrain et préparation du handoff. Chaque décision devait rester cohérente entre les applications B2C, les usages B2B et les contraintes opérationnelles de gestion de flotte."] },
        moment: { title: "Validation terrain", paragraphs: ["L'un des moments les plus marquants fut lorsque nous avons lancé la fonctionnalité de géolocalisation et d'accès sans clé. Voir un utilisateur ouvrir une voiture pour la première fois avec son smartphone a validé concrètement la promesse produit : réduire la friction entre réservation, accès et usage réel du véhicule."] },
        features: { title: "Solution", paragraphs: ["Chaque fonctionnalité que nous développions - de la réservation en ligne 24/7 à l'état des lieux digital - répondait à une friction opérationnelle identifiée. Les retours des utilisateurs nous aidaient à prioriser ce qui simplifiait réellement la gestion de flotte et l'expérience de mobilité."] },
        path: { title: "Impact", paragraphs: ["Novembre 2021 arriva plus vite que prévu. Alors que je regardais en arrière sur ces deux années et demie, je réalisais l'ampleur du chemin parcouru. Kirrk était devenu une référence dans l'autopartage d'entreprise, avec des taux d'utilisation des véhicules dépassant les 80%."] },
        learnings: { title: "Enseignements", paragraphs: ["Cette aventure avec Kirrk m'a appris que l'innovation dans la mobilité urbaine peut vraiment changer la vie des gens. Et bien que mon focus principal était sur Kirrk, les compétences que j'y ai développées ont également enrichi mon travail sur Mobioos, me permettant d'aborder la personnalisation des applications avec une nouvelle perspective centrée sur l'utilisateur."] },
        future: { 
          title: "Évolutions possibles", 
          paragraphs: [
    ...
    mobioos: {
      ...
      sections: {
        intro: { title: "Contexte", paragraphs: ["Avril 2019. Alors que je plongeais tête la première dans le projet Kirrk, une autre opportunité se présenta : Mobioos. Cette plateforme visait à simplifier la personnalisation des applications, un défi technique complexe mais fascinant. Bien que secondaire par rapport à Kirrk, Mobioos m'offrait l'occasion de plonger dans un domaine totalement différent, élargissant ainsi mon expertise en UX."] },
        playground: { title: "Problème produit", paragraphs: ["Mobioos était un projet mené en parallèle de Kirrk, avec un problème très différent : permettre aux développeurs et aux entreprises de personnaliser leurs applications sans réécrire du code à chaque variation. Le défi était technique, mais l’enjeu design restait clair : rendre ces choix compréhensibles et actionnables."] },
        juggling: { title: "Contraintes de focus", paragraphs: ["Le travail se faisait en parallèle de Kirrk, avec une implication plus ciblée. Cette contrainte demandait de concentrer l’effort design sur les zones où l’interface pouvait réellement réduire la complexité technique pour les utilisateurs non spécialistes."] },
        challenges: { title: "Contraintes techniques et UX", paragraphs: ["Les défis de Mobioos étaient uniques. Comment rendre la personnalisation d'applications accessible aux utilisateurs non techniques ? Comment s'assurer que la plateforme s'intègre facilement aux pratiques et outils existants des équipes ? Ces questions m'obligeaient à penser différemment, à adopter une perspective plus technique tout en gardant l'utilisateur final à l'esprit."] },
        moment: { title: "Décision d’interface", paragraphs: ["L'un des moments les plus gratifiants fut lorsque nous avons finalisé l'interface de Mobioos Fusion, permettant aux utilisateurs de sélectionner et d'appliquer des personnalisations via une interface conviviale. C'était fascinant de voir comment les principes de design centrés sur l'utilisateur que j'appliquais quotidiennement sur Kirrk pouvaient être adaptés à un contexte totalement différent avec Mobioos."] },
  ...
  en: {
    ...
    'tire-assistant': {
      ...
      sections: {
        ...
        tradeoffs: {
          title: "Trade-offs",
          paragraphs: [
            "The main trade-off was increasing proactivity without turning the assistant into an interruption. Notifications had to remain contextual, readable and limited to moments where they could genuinely support a decision.",
            "I also made sure the existing experience and organic SEO remained protected: the proactive layer had to enrich the journey without replacing useful content or pulling users away from their goal."
          ]
        },
        solution: {
          title: "Solution",
    ...
    masteos: {
      ...
      sections: {
        ...
        obstacles: {
          title: 'Trade-off: simplifying without dumbing down',
          paragraphs: [
        ...
        launch: {
          ...
          paragraphs: [
            'After several months of iterations, testing and alignment with product and engineering teams, we had an experience clear enough to launch. The launch had to validate a simple hypothesis: make real estate investing easier to understand without hiding its real complexity.'
          ]
        },
        results: {
          title: 'Impact',
          paragraphs: [
            'The first wave of feedback confirmed the value of the redesign. In just three months, signups increased by 200%. Users spent an average of 15 minutes per session in the app, with a clearer understanding of their investment options.'
          ]
        },
        validation: {
    ...
    helios: {
      ...
      sections: {
        intro: { title: "Internal context", paragraphs: ["As the Masteos application was taking off, a new adventure was emerging on the horizon. Our team, still euphoric from Masteos' success, faced a new challenge: building the back-office that would take Masteos to new heights."] },
        users: { title: "Users and needs", paragraphs: ["I was once again in command as a UX/UI Product Designer, but this time the challenge was different. We were no longer speaking to investors, but to Masteos' unsung heroes: our internal collaborators. Sales, property hunters, managers... each had specific needs, and it was our job to satisfy them all."] },
        challenge: { title: "Delivery constraints", paragraphs: ["The biggest challenge was leading two major products in parallel. Our team, made up of one PM, four developers, and myself, had to maintain Masteos' momentum while building Helios from the ground up, with fast decisions and enough documentation to secure delivery."] },
        daily: { title: "Trade-off between two products", paragraphs: ["Our days alternated between improving the investor experience and designing the internal back-office. This dual focus required prioritizing the most structural pain points while keeping product consistency between what customers saw and what teams operated."] },
        questions: { title: "Internal research", paragraphs: ["To understand Helios' needs, we conducted more than 15 interviews with our colleagues. Each conversation revealed new complexities. How could we simplify adding real estate properties? How could we optimize client positioning? These questions added to the already substantial stack of challenges we were tackling daily with Masteos."] },
        workshop: { title: "Co-design decisions", paragraphs: ["One of the most memorable moments came when we organized a co-creation workshop. Seeing colleagues from sales, real estate, and operations gathered in the same room, sharing frustrations and dreams for Helios, was a revelation. That is when I truly grasped the scale of our mission: we were not just building a tool, we were redefining how Masteos operated behind the scenes."] },
        battleground: { title: "From need to prototype", paragraphs: ["Between wireframes for new Masteos features and high-fidelity prototypes for Helios, the challenge was turning sometimes conflicting operational needs into testable journeys. Every iteration brought us closer to a clearer tool for internal teams."] },
        launch: { title: "Production rollout", paragraphs: ["The Helios launch had to prove that the back-office could simplify complex processes without pushing the complexity onto teams. The rollout was therefore treated as a product validation step as much as a technical delivery."] },
        success: { title: "Impact", paragraphs: ["The answer came quickly. Within six months, our internal NPS rose from 6.5 to 8.7. The processing time for an investment file was reduced by 40%. But the comment that touched me most came from Laura on the Sales team: \"It feels like we moved from driving a manual car to a luxury automatic one.\""] },
        evolution: { title: "Product ecosystem", paragraphs: ["This success was not the end, but rather a new beginning. With Helios and Masteos working in tandem, we had created a complete ecosystem. One could not exist without the other, and together they were transforming the real estate investment industry."] },
        innovation: { title: "Possible evolutions", paragraphs: ["Today, as we consider AI integration and the development of a mobile app for Helios, I cannot help but smile. This journey taught me that true innovation is not limited to what customers see. It also lives in the systems that power those experiences behind the scenes."] },
        design: { 
          title: "Learnings", 
          paragraphs: [
    ...
    myxpert: {
      ...
      sections: {
        ...
        legacy: {
          title: "Problem: tool fragmentation",
          paragraphs: [
        ...
        pivot: {
          title: "Key decision: moving to native",
          paragraphs: [
        ...
        agile: {
          title: "Product / tech / business alignment",
          paragraphs: [
        ...
        jargon: {
          title: "UX decision: reducing jargon",
          paragraphs: [
        ...
        launch: {
          title: "Product and legacy impact",
          paragraphs: [
    ...
    kirrk: {
      ...
      sections: {
        intro: { title: "Context", paragraphs: ["April 2019. Paris in spring was in full swing when I joined the Kirrk team, an ambitious startup in the car-sharing space. My role? UX/UI Designer, with a mission to turn their bold vision into a tangible digital reality."] },
        ambition: { "title": "Product problem", "paragraphs": ["Kirrk was my main project, the center of my professional activity for the next two and a half years. Our goal was clear but ambitious: simplify the use of corporate vehicle fleets. Our team, made up of around twenty developers, one or two designers depending on the phase, and a product manager, had to build a car-sharing platform that worked smoothly for both end users and fleet managers."] },
        challenges: { "title": "Constraints and stakes", "paragraphs": ["The challenges were titanic. How could we optimize fleet usage? How could we reduce operational costs while delivering a seamless user experience? And above all, how could we promote sustainable mobility in a world still heavily dependent on fossil fuels?"] },
        daily: { "title": "Design decisions", "paragraphs": ["The day-to-day work moved between functional framing, journey design, field user testing and handoff preparation. Every decision had to remain coherent across B2C apps, B2B usage and the operational constraints of fleet management."] },
        moment: { "title": "Field validation", "paragraphs": ["One of the most memorable moments came when we launched the geolocation and keyless access feature. Seeing a user unlock a car for the first time with their smartphone concretely validated the product promise: reducing friction between booking, access and real vehicle usage."] },
        features: { "title": "Solution", "paragraphs": ["Every feature we developed - from 24/7 online booking to digital vehicle inspection - answered an identified operational friction. User feedback helped us prioritize what genuinely simplified fleet management and the mobility experience."] },
        path: { "title": "Impact", "paragraphs": ["November 2021 came faster than expected. Looking back on those two and a half years, I realized how far we had come. Kirrk had become a benchmark in corporate car sharing, with vehicle usage rates exceeding 80%."] },
        learnings: { "title": "Learnings", "paragraphs": ["This adventure with Kirrk taught me that innovation in urban mobility can truly change people's lives. And while my main focus was Kirrk, the skills I developed there also enriched my work on Mobioos, allowing me to approach application customization with a new user-centered perspective."] },
        future: { 
          title: "Possible evolutions", 
          paragraphs: [
    ...
    mobioos: {
      ...
      sections: {
        intro: { title: "Context", paragraphs: ["April 2019. As I was diving headfirst into the Kirrk project, another opportunity emerged: Mobioos. This platform aimed to simplify application customization, a complex but fascinating technical challenge. Although secondary compared to Kirrk, Mobioos gave me the chance to dive into a completely different domain, broadening my UX expertise."] },
        playground: { title: "Product problem", paragraphs: ["Mobioos was run alongside Kirrk, with a very different problem: allow developers and companies to customize applications without rewriting code for every variation. The challenge was technical, but the design goal remained clear: make those choices understandable and actionable."] },
        juggling: { title: "Focus constraints", paragraphs: ["The work happened alongside Kirrk, with a more targeted involvement. That constraint required concentrating design effort on the areas where the interface could genuinely reduce technical complexity for non-specialist users."] },
        challenges: { title: "Technical and UX constraints", paragraphs: ["Mobioos brought unique challenges. How do we make application customization accessible to non-technical users? How do we ensure the platform integrates smoothly with teams' existing workflows and tools? These questions pushed me to think differently, adopting a more technical perspective while keeping the end-user in mind."] },
        moment: { title: "Interface decision", paragraphs: ["One of the most rewarding moments came when we finalized the Mobioos Fusion interface, allowing users to select and apply customizations through a user-friendly experience. It was fascinating to see how user-centered design principles I was applying daily on Kirrk could be adapted to a completely different context with Mobioos."] },
        ...
        synergy: { title: "Trade-off between projects", paragraphs: ["The two projects, while different, fed each other. Lessons learned about user experience on Kirrk influenced how I approached Mobioos' interface. And in return, thinking about customization with Mobioos inspired me to make Kirrk even more adaptable to each company's specific needs."] },
        launch: { title: "Delivery", paragraphs: ["November 2021. As Kirrk reached cruising speed, Mobioos was preparing for launch, promising to transform how companies approach application customization. Although my involvement in Mobioos was less intensive than in Kirrk, I felt similar pride seeing the product take shape."] },
